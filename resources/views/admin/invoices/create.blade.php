...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Create A new Invoice</h6>
                    <form method="POST" action="{{ route('invoices.store') }}" class="forms-sample"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" name="invoice_Date"
                                    ...
                                    id="invoice_Date" autocomplete="off" placeholder="invoice Date"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="Amount_commission" id="amount_commission_id"
