...
class Partially_PaidDataTable extends DataTable
{
    /**
    ...
    {
        return $model->where('invoice_status','partially_paid');
    }
    ...
    {
        return $this->builder()
                    ->setTableId('partially_paid-table')
    ...
    {
        return 'Partially_Paid_' . date('YmdHis');
    }
}
