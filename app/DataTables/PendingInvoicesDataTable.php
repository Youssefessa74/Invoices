...
class PendingInvoicesDataTable extends DataTable
{
    /**
    ...
    {
        return $model->where('invoice_status','pending');
    }
    ...
    {
        return $this->builder()
                    ->setTableId('pendinginvoices-table')
    ...
    {
        return 'PendingInvoices_' . date('YmdHis');
    }
}
